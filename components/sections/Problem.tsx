    ...
    <section ref={ref} className="sec-pad problem" id="problem">
      <div className="wrap">
        <div className="head-wrap">
          <span className="sec-index sec-index--dark" aria-hidden="true">02</span>
          <motion.div
            className="sec-head"
          ...
          >
            <span className="eyebrow eyebrow--dark">
              <span className="num">02</span>&nbsp; The Expensive Problem
            </span>
          ...
          <div className="hidden-grid">
            {HIDDEN_COSTS.map((c, i) => (
              <motion.div
                ...
                initial={reduce ? false : { opacity: 0, y: 24 }}
                animate={inView ? { opacity: 1, y: 0 } : {}}
                transition={{ type: 'spring', damping: 25, stiffness: 110, delay: 0.12 + i * 0.06 }}
                whileHover={reduce ? undefined : { y: -3, backgroundColor: 'rgba(244,239,230,0.07)' }}
              >
                ...
                <p style={{ fontSize: 12.5, color: 'var(--bone-quiet)', lineHeight: 1.5 }}>{c.body}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <style jsx>{`
        ...
        .vb-note { font-size: 13.5px; color: var(--bone-quiet); font-style: italic; }
